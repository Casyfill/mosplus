...
$('.download').click(function(){
  ...
  var queryTemplate = 'https://pbk236.cartodb.com/api/v2/sql?skipfields=cartodb_id,created_at,updated_at,name,description&format={{type}}&filename=mosbld&q=SELECT the_geom{{fields}} FROM mosplus01 WHERE ST_INTERSECTS({{{intersects}}}, the_geom)';
